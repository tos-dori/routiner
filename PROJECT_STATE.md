...
- 기준 커밋: `66a568cc888c7bb6c74f15c95fa85cf0730a3cd7` (`Use size-specific Routiner favicons`).
...
2. favicon 결과를 실제 브라우저·홈 화면에서 확인할 필요가 있으면 캐시 조건을 포함해 검증한다.
3. 제품 작업을 수행하고 검증된 상태 변화가 있으면 이 파일의 관련 섹션만 최소 갱신한다.
